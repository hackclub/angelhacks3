  ...
  return (
    <div>
      <div class="container" style={{margin: '0px', padding: '10rem', backgroundColor: 'black', color: '#e0e6ed'}}>
        <h1 style={{fontWeight: '900', fontSize: '4rem'}}><span style={{color: '#009AAB'}}>Angel</span><span style={{color: '#ffb400'}}>Hacks</span> 3.0</h1>
        <p style={{fontSize: '1.5rem'}}>👾 A game jam for the makers, gamers, coders, artists, musicians, and storytellers of the world. 📍 Boston, ⏳ late-May, ⏰ more details to come.</p>
        <br />
      ...
      <div class="container" style={{backgroundColor: '#1b1a1f', margin: '0px', color: 'white', padding: '4rem'}}>
        ...
        <p style={{fontSize: '1.5rem', lineHeight: '2rem'}}>AngelHacks is a game jam, which means you’re <span style={{fontWeight: '800'}}>only</span> allowed to make games - video games, board games, puzzle hunts, VR games, ARGs… all are game (hehe get it?). <br /><br />This means 🧑‍🎨 artists, 🎨 designers, 🎹 musicians, 📚 storytellers, 👩‍💻 coders, 🎲 gamers… all are welcome. We also have three satellite events across the globe (🌴 Los Angeles, 🌉 San Francisco, and 🇨🇦 Toronto)!! For those who have heard of AngelHacks or been to it in the past, we promise to keep the vibes of angelhacks 1.0 & 2.0 combine with the magic and community of hack club. <br /><br /> </p>
        <p style={{color: '#ffdc89', textDecoration: 'none'}}>Check out our <a href="https://www.youtube.com/watch?v=rv_UycMxEsQ">1.0 recap</a> and our <a href="https://www.youtube.com/@angelhacks5695">2.0 youtube channel</a>!</p>
      </div>
      {/* <div class="container">
