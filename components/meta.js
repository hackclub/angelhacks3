    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          description:
            'Register today for 24 hours of making games, coding, fun, free food, and prizes. AngelHacks 3.0 will be in Boston from May 27-28 and open to all middle and high school students.',
          ...
          offers: {
            ...
            validThrough: '2019-05-28'
          },
          performer: {
            '@type': 'PerformingGroup',
            name: 'AngelHacks Team'
          }
        })
      }}
    />
